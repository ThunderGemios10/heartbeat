	...
	<div class="row pull-left">	 -->  	  
	   ...
	   <div id="videoNode" class="row col-md-6"> -->
	    <div class="row boxed no-shadow has-padding redHover" ng-init="newRow.rating=[];">
			...
			<br/>		
			<table class="table table-condensed col-md-6" ng-init="max=5;isReadonly=false;howHover=false" ng-mouseover="howHover=true" ng-mouseleave="howHover=false" ng-show="primaryPick">
				<tr class="container boxed no-shadow">
					<td class="has-padding-sm">
						<i class="glyphicon glyphicon-remove pull-left" ng-class="{false:'color-white',true:''}[howHover]" ng-show="primaryPick.selectedLevel" ng-click="removeTag('primaryIntensity')"></i>					
					</td>
					<td class="col-md-5">
						<div class="container has-padding-sm has-padding-left-1" ng-show="tags.length>0">
							How {{primaryPick.name}}<span ng-hide="primaryPick.prefix">?</span> &raquo;
						</div>
					</td>
			...
			<br/>
			<table class="table table-condensed col-md-6" ng-init="max=5;isReadonly=false;copyrightHover=false" ng-mouseover="copyrightHover=true" ng-mouseleave="copyrightHover=false" ng-show="primaryPick.selectedLevel || secondaryPick">
				<tr class="container boxed no-shadow">
					<td class="has-padding-sm">
						<i class="glyphicon glyphicon-remove pull-left" ng-class="{false:'color-white',true:''}[copyrightHover]" ng-show="secondaryPick" ng-click="removeTag('copyright')"></i>					
					</td>
					<td class="col-md-1">
						<div class="container has-padding-sm has-padding-left-1" ng-show="tags.length>0">
							Copyright
			...
			<table class="table no-margin table-condensed col-md-6" ng-init="max=5;isReadonly=false;languageHover=false" ng-mouseover="languageHover=true" ng-mouseleave="languageHover=false" ng-show="secondaryPick || language">
				<tr class="container boxed no-shadow">
					<td class="col-md-1 has-padding-sm">
						<i class="glyphicon glyphicon-remove pull-left" ng-class="{false:'color-white',true:''}[languageHover]" ng-show="language" ng-click="removeTag('language')"></i>
					</td>
					<td class="col-md-3">
			...
			<table class="table table-condensed col-md-6" ng-init="max=5;isReadonly=false;" ng-show="secondaryPick || language">						
			...
			<table class="table no-margin table-condensed col-md-6" ng-init="max=5;isReadonly=false;gamesHover=false" ng-mouseover="gamesHover=true" ng-mouseleave="gamesHover=false" ng-show="language || game">
				<tr class="container boxed no-shadow">
					<td class="col-md-1 has-padding-sm">
						<i class="glyphicon glyphicon-remove pull-left" ng-class="{false:'color-white',true:''}[gamesHover]" ng-show="game" ng-click="removeTag('game')"></i>
					</td>
					<td class="col-md-3">
						<div class="container has-padding-sm" ng-show="tags.length>0">
							Games
			...
			<table class="table table-condensed col-md-6" ng-init="max=5;isReadonly=false;" ng-show="language || game">						
				<tr ng-repeat="newGame in game" class="container boxed no-shadow">
					<td class="col-md-6">
						<div ng-show="tags.length>0" class="has-padding-sm">
							<a href="">{{newGame.prefix}} {{newGame.name}}</a>
						</div>
					</td>
					<td class="col-md-6 no-padding">
						<div class="btn-group side-boxed" data-toggle="buttons">
						  <label class="btn" ng-repeat="intensities in newGame.intensity" ng-class="{true:'active',false:'false'}[newLanguage.selectedLevel==intensities.level]" ng-click="newLanguage.prefix=intensities.defaultName;newLanguage.selectedLevel=intensities.level">
							<input type="radio" ng-model="pick" ng-hide="true"> {{intensities.defaultName}}</input>
						  </label> 			  
						</div>	
					</td>
			...
			<table class="table no-margin table-condensed col-md-6" ng-init="max=5;isReadonly=false;freeformHover=false" ng-mouseover="freeformHover=true" ng-mouseleave="freeformHover=false" ng-show="game || rating">
				<tr class="container boxed no-shadow  no-margin">
					<td class="col-md-1 has-padding-sm">
						<i class="glyphicon glyphicon-remove pull-left" ng-class="{false:'color-white',true:''}[freeformHover]" ng-show="rating" ng-click="removeTag('tags')"></i>
					</td>
					<td class="col-md-4">
						<div class="container has-padding-sm" ng-show="tags.length>0">
							Tags
			...
			<table class="table table-condensed col-md-6" ng-init="max=5;isReadonly=false;" ng-show="game || rating">
